...
const seo = {
  ...
  description:
    "Cybersecurity student focusing on malware analysis, reverse engineering and security research.",
  og: {
    title: "Nguyen Pham Tri Portfolio",
    type: "website",
...
const socialMediaLinks = [
  ...
  {
    name: "LinkedIn",
    link: "www.linkedin.com/in/trinpce192008",
  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Linux System Security and Monitoring",
        "⚡ Basic Incident Response and Security Research"
      ],
      softwareSkills: [
        {
          skillName: "Wireshark",
